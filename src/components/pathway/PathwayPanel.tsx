...
export function PathwayPanel({
  ...
  if (isMobile) {
    ...
    return (
      <div
        className="fixed inset-x-0 bottom-0 z-40 h-[calc(33vh+1cm)] max-h-[calc(33vh+1cm)] bg-[#0d0d18] border-t border-cyan-900/30 rounded-t-2xl shadow-2xl flex flex-col animate-fade-in"
